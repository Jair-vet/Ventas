<?php
	session_start();
	if($_SESSION['rol'] != 1 and $_SESSION['rol'] != 3 ) // Solo Admi y Supervisores pueden ver
	{ 
		header("location: ./");
	}
	...
	<section id="container">
		...
		<div class="data_delete">
			...
			<form action="" method="post" enctype="multipart/form-data">
				...
				<p> Descripción: <span><?php echo $data_producto['descripcion']; ?></span></p>
				...
				<a href="catalogo.php" class="btn_cancel"><i class="fas fa-undo-alt"></i> Regresar</a>
				<a href="ventas.php"><img class="carro" src="img/carrito.jpg" alt="Agregar Producto" title="Agregar"> </a>
			</form>
